<template>
     <nav class="navbar nav-bar navbar-expand-md navbar-light  fixed-top">
       <div class="container">
           ...
           data-bs-toggle="collapse"
			...
			<div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
				<ul class="navbar-nav m-auto justify-contente-end ">
                    <li class="nav-item">
        ...
        <router-link to="/cart" class="nav-link">	<i class="fas fa-shopping-cart fs-5"></i></router-link>
        <span class="position-absolute top-0 start-100 translate-middle badge rounded-circle bg-success mt-xl-2 ms-n1">({{ cartTotalLength }}) 
       ...
       <li class="navbar-nav d-none d-lg-inline-block">
                      <router-link to="/signup" class="btn btn-danger-soft mb-0"><i class="fa fa-sign-in-alt me-2"></i>Sign Up</router-link>
            </li>
