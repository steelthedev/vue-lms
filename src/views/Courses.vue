...
<!-- =======================
Page Banner START -->
<section class="bg-blue align-items-center banner-page d-flex">
	<div class="container">
		<div class="row">
...
<div class="container">
	<div class="row">
		...
		<div class="col-lg-8 col-xl-9">
			...
			<div class="row mb-4 align-items-center">
				...
				<div class="col-xl-6">
					<form class="border rounded p-2">
						<div class="input-group input-borderless">
							<input class="form-control me-1 shadow-none " type="search" placeholder="Find your course">
							<button type="button" class="btn btn-primary shadow-none mb-0 rounded z-index-1"><i class="fas fa-search"></i></button>
						</div>
					</form>
				</div>
				...
				<div class="col-xl-3 mt-3 mt-xl-0">
					<form class="border rounded p-2 input-borderless">
						<select class="form-select form-select-sm js-choice shadow-none border-0" aria-label=".form-select-sm">
				...
				<div class="col-12 col-xl-3 d-flex justify-content-between align-items-center mt-3 mt-xl-0">
					...
					<button class="btn btn-primary mb-0 d-lg-none shadow-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar">
			...
			<!-- Course Grid START -->
			<div class="row g-4" v-if="courses">
