		...
		<div class="row position-relative mb-0 mb-sm-5 pb-0 pb-lg-5">
			<div class="col-lg-8 text-center mx-auto position-relative">
				...
				<div class="col-md-8 text-center mx-auto pb-5">
					<form class="bg-body shadow rounded p-2" action="/search" method="get">
						<div class="input-group">
							<input class="form-control shadow-none border-0 me-1" name="query" type="search" placeholder="Find your course">
							<button type="submit" class="btn shadow-none btn-primary mb-0 rounded z-index-1"><i class="fas fa-search"></i></button>
						</div>
					</form>
				</div>
			</div>
			...
			<div class="col-sm-6 col-lg-4 col-xl-3"  v-for="category in categories" :key="category.id">
				<div class="card card-body shadow rounded-3" >
					<div class="d-flex align-items-center">
						...
						<div class="ms-3" >
							<h5 class="mb-0"><a href="#" class="stretched-link">{{category.title}}</a></h5>
	...
	<div class="container">
		...
		<div class="row mb-4">
			<div class="col-lg-8 text-center mx-auto">
				<h2 class="fs-1 mb-0">Latest Courses</h2>
				<p class="mb-0">Explore new picks of the week </p>
			</div>
		</div>

		<div class="row g-4">
			<!-- Card Item START -->
			<div class="col-md-6 col-lg-4 col-xxl-3" v-for="course in latest_courses" :key="course.id">
	...
	<div class="container">
		...
		<div class="row g-4">
			...
			<div class="col-sm-6 col-lg-4 col-xl-3" v-for="course in courses " :key="course.id">
              ...
              <router-link class="text-white mt-auto h5 stretched-link" :to="{name:'Course', params: {slug : course.slug}}">{{course.title}}</router-link>
...
export default {
  ...
  methods:{
      ...
      getLatestCourses(){
          this.loading = true
         axios
        .get('courses/course-latest_list')
        .then(response => {
            console.log(response.data)
            this.latest_courses = response.data
            this.loading = false
        })
      },
