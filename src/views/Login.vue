				...
				<div class="col-12 col-lg-6 m-auto">
					<div class="row my-5">
						<div class="col-sm-10 col-xl-8 m-auto">
							...
							<h1 class="fs-2">Login into iEdu!</h1>
							...
							<form @submit.prevent="SubmitForm">
								...
								<div class="mb-4">
									...
									<div class="input-group input-group-lg">
										...
										<input type="text" v-model="username"  required class="form-control border-0 bg-light rounded-end ps-1" placeholder="Username" id="exampleInputEmail1">
									</div>
								</div>
								<!-- Password -->
								<div class="mb-4">
									...
									<div class="input-group input-group-lg">
										...
										<input type="password" required v-model="password" class="form-control border-0 bg-light rounded-end ps-1" placeholder="password" id="inputPassword5">
									</div>
