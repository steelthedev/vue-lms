<template>
    <!-- <Navbar />
        <section class="courses p-5 mt-5 pt-5">
                            ...
                            <template v-if="activeLesson" >
                                ...
                                <form @submit.prevent="SubmitForm">
                                    <div class="row justify-content-center">
                                        ...
                                        <input type="text" class=" shadow-none form-control" v-model="comment.name">
                                    </div>

                                     <div class="form-group mb-3">
                                        <label for="name">Comment</label>
                                        <input type="text" class="shadow-none form-control" v-model="comment.content">
                                    </div>
                                       
                                         <button class="btn btn-success p-2 btn-outline-white" type="submit">Submit</button>
                                     </div>
                                    </div>
...
<section class="bg-light py-0 py-sm-5">
	<div class="container">
		<div class="row py-5">
			<div class="col-lg-8">
				<!-- Badge -->
				<h6 class="mb-3 font-base bg-primary text-white py-2 px-4 rounded-2 d-inline-block"></h6>
				<!-- Title -->
				<h1>{{course.title}}</h1>
					...
					<div class="card-body p-4">
						<div class="tab-content pt-2" id="course-pills-tabContent">
							...
							<div class="tab-pane fade show active" id="course-pills-1" role="tabpanel" aria-labelledby="course-pills-tab-1">
								...
								<p class="mb-0" v-html="course.long_description"> </p>
								<!-- List content -->
						...
						<div class="card shadow p-2 mb-4 z-index-9">
							...
							<div class="card-body px-3">
								...
								<div class="mt-3 d-sm-flex justify-content-sm-between">
									...
									<a @click="addToCart" type="button" class="btn btn-success mb-0">Buy course</a>
								</div>
							</div>
						</div>
						<!-- Video END -->
