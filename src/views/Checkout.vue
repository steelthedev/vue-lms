					...
					<div class="d-flex justify-content-center">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb breadcrumb-dots mb-0">
								...
								<li class="breadcrumb-item"><router-link :to="{name:'Cart'}"> Cart </router-link></li>
		...
		<div class="row g-4 g-sm-5">
			...
			<div class="col-xl-8 mb-4 mb-sm-0" >
				...
				<div class="card card-body shadow p-4" >
					...
					<!-- Form START -->
					<form class="row g-3 mt-0" v-if="!$store.state.isAuthenticated">
            	<div class="alert alert-danger alert-dismissible d-flex justify-content-between align-items-center fade show py-2 pe-2" role="alert">
					<div>
						...
						Already have an account? <router-link :to="{name:'Login'}" class="text-reset btn-link mb-0 fw-bold">Log in</router-link></div>
			...
			<div class="col-xl-4">
				<div class="row mb-0">
					<div class="col-md-6 col-xl-12">
						...
						<div class="card card-body shadow p-4 mb-4">
							...
							<!-- Course item START -->
							<div class="row g-3" v-for="item in cart.items" :key="item.product.id">
								<!-- Image -->
								<div class="col-sm-4">
									<img class="rounded" :src="item.product.get_image" alt="">
								</div>
								<!-- Info -->
								<div class="col-sm-8">
									<h6 class="mb-0"><a href="#">{{item.product.title}}</a></h6>
									<!-- Info -->
                ...
                <li class="list-group-item px-0 d-flex justify-content-between">
                  ...
                  <span class="h6 fw-light mb-0 fw-bold">#{{cartTotalPrice}}</span>
                </li>
                <li class="list-group-item px-0 d-flex justify-content-between">
                ...
                <li class="list-group-item px-0 d-flex justify-content-between">
                  ...
                  <span class="h5 mb-0">#{{cartTotalPrice}}</span>
                </li>
              </ul>
...
<paystack
   ...
   :publicKey="'pk_test_ef1bea703713ac519754d7b88f3b56ea141c1d67'"
   :email="email"
