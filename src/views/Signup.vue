							...
							<form @submit.prevent="SubmitForm">
								...
								<div class="mb-4">
									...
									<div class="input-group input-group-lg">
										...
										<input type="text" v-model="username" class="form-control border-0 bg-light rounded-end ps-1" placeholder="Username" id="exampleInputEmail1">
									</div>
								</div>
								<!-- Password -->
								<div class="mb-4">
									...
									<div class="input-group input-group-lg">
										...
										<input type="password"  v-model="password1" class="form-control border-0 bg-light rounded-end ps-1" placeholder="*********" id="inputPassword5">
									</div>
								</div>
								<!-- Confirm Password -->
								<div class="mb-4">
									...
									<div class="input-group input-group-lg">
										<span class="input-group-text bg-light rounded-start border-0 text-secondary px-3"><i class="fas fa-lock"></i></span>
										<input type="password" v-model="password2" class="form-control border-0 bg-light rounded-end ps-1" placeholder="*********" id="inputPassword6">
									</div>
								</div>
								<!-- Check box -->
