 ...
 -->
						...
						<table class="table align-middle p-4 mb-0">
							...
							<tbody class="border-top-0">
								...
								<tr v-for="item in cart.items" :key="item.product.id">
									...
									<td>
										<div class="d-lg-flex align-items-center">
											...
											<div class="w-100px w-md-80px mb-2 mb-md-0">
												<img :src="item.product.get_image" class="rounded" alt="">
											</div>
											<!-- Title -->
									...
									<!-- Amount item -->
									<td>
										<h5 class="text-success mb-0">#{{item.product.price}}</h5>
									</td>
									<!-- Action item -->
									<td>
										<a href="#" class="btn btn-sm btn-success-soft px-2 me-1 mb-1 mb-md-0"><i class="far fa-fw fa-edit"></i></a>
                                        
										<button @click="removeFromCart(item)" class="btn btn-sm btn-danger-soft px-2 mb-0" disabled><i class="fas fa-fw fa-times"></i></button>
									</td>
								</tr>
					...
					<div class="row g-3 mt-2">
						...
						<div class="col-md-6 text-md-end">
							<button @click="updateCart" class="btn btn-primary mb-0" disabled>Update cart</button>
						</div>
					</div>	
				</div>
			</div>
				...
				<div class="card card-body p-4 shadow">
					...
					<ul class="list-group list-group-borderless mb-2">
						<li class="list-group-item px-0 d-flex justify-content-between">
							...
							<span class="h6 fw-light mb-0 fw-bold">#{{cartTotalPrice.toFixed(2)}}</span>
						</li>
						<li class="list-group-item px-0 d-flex justify-content-between">
						...
						<li class="list-group-item px-0 d-flex justify-content-between">
							...
							<span class="h5 mb-0">#{{cartTotalPrice.toFixed(2)}}</span>
						</li>
					</ul>

					<!-- Button -->
					<div class="d-grid">
						<router-link :to="{name:'Checkout'}" class= "btn btn-lg btn-success" >Proceed to Checkout</router-link>
					</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-12 text-center">
				...
				<!-- Button -->
				<router-link to="/"  class="btn btn-primary mt-4 mb-0">Back to Shop</router-link>
			</div>
		</div>
	</div>
</section>
