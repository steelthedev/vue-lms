					...
					<div class="row d-flex justify-content-between">
						...
						<div class="col d-md-flex justify-content-between align-items-center mt-4">
							<div>
								...
								<ul class="list-inline mb-0" v-if="profile.status ==='instructor'">
				...
				<div class="card bg-transparent border rounded-3">
					...
					<div class="card-body">
						...
						<form class="row g-4" @submit.prevent="submitChanges">
								...
								<div class="d-flex align-items-center">
									<label class="position-relative me-4" for="uploadfile-1" title="Replace this pic">
										...
										<span class="avatar avatar-xl">
											<img id="uploadfile-1-preview" class="avatar-img rounded-circle border border-white border-3 shadow" :src="profile.get_profile_picture" alt="">
										</span>
										<!-- Remove btn -->
							...
							<!-- Education -->
							<div class="col-12" v-if="profile.status === 'instructor' ">
